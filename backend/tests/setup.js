...
process.env.LOCI_SUPABASE_URL = 'https://test.supabase.co';
process.env.LOCI_SUPABASE_ANON_KEY = 'test-anon-key';
process.env.LOCI_SUPABASE_SERVICE_KEY = 'test-service-key';
process.env.LOCI_OPENAI_API_KEY = 'test-openai-key';
